...
INSERT_INTO_DASHBOARD = \
    "INSERT INTO DASHBOARD VALUES (%s, %s, %s, %s, %s, %s, %s)"
...
UPDATE_DASHBOARD = \
    "UPDATE DASHBOARD SET CONTAINERS=%s, METRICS=%s,DATE_UPDATED=%s WHERE NAME=%s"
DELETE_DASHBOARD = \
    "DELETE FROM DASHBOARD WHERE NAME=%s"
DELETE_FROM_DASHBOARDS= \
    "DELETE FROM dashboards WHERE NAME=%s"
LIST_DASHBOARD =\
     "SELECT NAME, DASHBOARD_URL FROM DASHBOARD"
LIST_EXPORTER=\
