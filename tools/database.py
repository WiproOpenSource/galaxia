...
def main():
    ...
    conn.execute("CREATE TABLE METRICS(METRICS_NAME VARCHAR(200),\
                 METRICS_UNIT_TYPE VARCHAR(40), METRICS_UNIT_SUBTYPE VARCHAR(40), METRICS_HELP VARCHAR(800),\
                 METRICS_TYPE VARCHAR(40))")
    ...
    with open(options.csvfile) as f:
        for line in f:
            conn.execute("INSERT INTO METRICS VALUES("+line+")")
